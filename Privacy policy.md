...
This Privacy Notice for Code du Soleil ("**we**," "**us**," or "**our**"), describes how and why we might access, collect, store, use, and/or share ("**process**") your personal information when you use our services ("**Services**"), including when you:

*   Download and use our mobile application (Dicto), or any other application of ours that links to this Privacy Notice

*   Use Dicto. A fast-paced word-guessing game where teams of players compete against each other.

*   Engage with us in other related ways, including any sales, marketing, or events

**Questions or concerns?** Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at soalexandrion1997@gmail.com.
...
*   _Mobile Device Access._ We may request access or permission to certain features from your mobile device, including your mobile device's local storage, your device's volume level, and other features. If you wish to change our access or permissions, you may do so in your device's settings.

This information is primarily needed to maintain the operation and functionality of our application(s). Note that this information is requested and exists only on the device where the application was installed on and it is not sent to us in any way.
...
*   **Device volume level**.** The device volume level is requested at the beginning of each game to inform players that raising the volume might make other players aware of the game round's finish, as we use a specific sound to signal it

*   **Local Storage**.** Dicto requests access to the app's dedicated local storage (read/write/update permissions), in order to maintain the "Save/Continue Game" functionalities
...
*   In order to make the player aware that the timer will make a sound when it's nearly ending and increasing the volume increases the chances of others hearing it too

*   In order to save and retrieve the state of the game if you decide to continue the game later
...
If you have questions or comments about your privacy rights, you may email us at soalexandrion1997@gmail.com.
...
<span data-custom-class="body_text"></span><span data-custom-class="body_text">NO</span><span data-custom-class="body_text"></span>
</div>
<div style="line-height: 1.5;">
<br />
...
<div data-custom-class="body_text" style="line-height: 1.5;">
<span data-custom-class="body_text"></span><span style="font-size: 15px; color: rgb(89, 89, 89);"><span style="font-size: 15px; color: rgb(89, 89, 89);"><span data-custom-class="body_text">NO</span></span></span>
</div>
<div style="line-height: 1.5;">
<br />
...
To exercise these rights, you can contact us by emailing us at soalexandrion1997@gmail.com, or by referring to the contact details at the bottom of this document.
...
**Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at soalexandrion1997@gmail.com. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.**
...
Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. Dicto is not storing any data. However, to request to review, update, or delete your personal information, provided by contacting us, please do it by email at: soalexandrion1997@gmail.com
